...
namespace Discord
{
    ...
    public struct ChannelPermissions
    {
        ...
        public static readonly ChannelPermissions Text = new ChannelPermissions(0x3007FC51);
        /// <summary> Gets a ChannelPermissions that grants all permissions for voice channels. </summary>
        public static readonly ChannelPermissions Voice = new ChannelPermissions(0x13F00411);
        /// <summary> Gets a ChannelPermissions that grants all permissions for category channels. </summary>
        public static readonly ChannelPermissions Category = new ChannelPermissions(0x33F7FC51);
        /// <summary> Gets a ChannelPermissions that grants all permissions for direct message channels. </summary>
        public static readonly ChannelPermissions DM = new ChannelPermissions(0x235CC00);
        /// <summary> Gets a ChannelPermissions that grants all permissions for group channels. </summary>
        public static readonly ChannelPermissions Group = new ChannelPermissions(0x230D800);
