...
namespace Discord
{
    ...
    public struct GuildPermissions
    {
        ...
        public static readonly GuildPermissions Webhook = new GuildPermissions(0xD800);
        /// <summary> Gets a GuildPermissions that grants all guild permissions. </summary>
        public static readonly GuildPermissions All = new GuildPermissions(0x7FF7FCFF);
