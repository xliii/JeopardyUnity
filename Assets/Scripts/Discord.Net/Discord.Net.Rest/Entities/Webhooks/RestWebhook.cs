...
namespace Discord.Rest
{
    ...
    public class RestWebhook : RestEntity<ulong>, IWebhook, IUpdateable
    {
        ...
        IGuild IWebhook.Guild
            => Guild ?? null; //throw new InvalidOperationException("Unable to return this entity's parent unless it was fetched through that object.");
        ITextChannel IWebhook.Channel 
            => Channel ?? null; //throw new InvalidOperationException("Unable to return this entity's parent unless it was fetched through that object.");
